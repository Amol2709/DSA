...
The function twoSum should return indices of the two numbers such that they add up to the target,
 ...
 are not zero-based. Put both these numbers in order 
 in an array and return the array from your function
...
class Solution:
    ...
    def twoSum(self, A, k):
        ...
        for i in range(n) :
            if k - A[i] in present :
                return [ present[k - A[i]] + 1, i + 1 ]
            elif A[i] not in present :
                present[A[i]] = i
        return []
